        ...
        try:
            ...
            test_spec = {
                ...
                "phases": {
                    "install": {
                        "commands": [
                            "python3.7 -m pip install --user git+https://github.com/paulo-raca/adb-proxy.git"
                        ],
                    },
                    "test": {
                        "commands": [
                            f'python3.7 -m adbproxy connect-reverse --no-adb-reverse -s $DEVICEFARM_DEVICE_UDID "{userhostport(ssh_path)}"'
                        ]
                    },
                }
            }
